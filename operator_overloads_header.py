...
def constructor_reverse_priority_header(
    new_base_type: str,
    new_types: List[str],
    priority: Dict[str, int],
    outfile: TextIO,
...
def overload_equal_reverse_priority_header(
    new_base_type: str,
    new_types: List[str],
    priority: Dict[str, int],
    outfile: TextIO,
...
def overload_plusequal_reverse_priority_header(
    new_base_type: str,
    new_types: List[str],
    priority: Dict[str, int],
    outfile: TextIO,
...
def overload_minusequal_reverse_priority_header(
    new_base_type: str,
    new_types: List[str],
    priority: Dict[str, int],
    outfile: TextIO,
...
def overload_prodequal_reverse_priority_header(
    new_base_type: str,
    new_types: List[str],
    priority: Dict[str, int],
    outfile: TextIO,
...
def overload_divequal_reverse_priority_header(
    new_base_type: str,
    new_types: List[str],
    priority: Dict[str, int],
    outfile: TextIO,
